...
-(id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        SKSpriteNode *brakeNode = [SKSpriteNode spriteNodeWithImageNamed:@"video_camera.png"];
        brakeNode.position = CGPointMake(size.width * 0.4, size.height*0.4);
        brakeNode.name = @"brakePressed";
        brakeNode.xScale = 0.6 * scale;
        brakeNode.yScale = 0.6 * scale;
